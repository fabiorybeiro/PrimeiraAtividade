package br.usjt.arqdesis.primeiraatividade.util;
...
public class Utils {
    ...
    private static br.usjt.arqdesis.primeiraatividade.util.StatusTracker mStatusTracker = br.usjt.arqdesis.primeiraatividade.util.StatusTracker.getInstance();
